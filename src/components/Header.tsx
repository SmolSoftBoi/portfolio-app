    ...
    <header className="profile-header" style={{
      ...
      <Container className="p-4" fluid>
        <div className="container-inner">
          <Image className="media-object rounded-circle" src={profilePic} alt="Kristian Matthews-Kennington" />
      ...
      <div className="profile-header-nav">
        <Nav className="justify-content-center sticky-top" variant="tabs">
          ...
          <Nav.Item>
            <Nav.Link href="/about" active={pathname === '/about'}>About Me</Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link href="/portfolio" active={pathname === '/portfolio'}>Portfolio</Nav.Link>
          </Nav.Item>
        </Nav>
      </div>
    </header>
